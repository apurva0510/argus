...
def test_readme_script_commands_exist():
    ...
    for script_rel_path in script_matches:
        ...
        assert script_abs_path.exists(), f"README references non-existent python script: {script_rel_path}"
    ...
    for app_rel_path in app_matches:
        ...
        assert app_abs_path.exists(), f"README references non-existent app entrypoint: {app_rel_path}"
