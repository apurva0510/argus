...
THEMES: list[tuple[str, str]] = [
    ...
    ("ai_semiconductors_memory", "AI Semiconductors and Memory"),
...
THEME_PARENT_CODES: dict[str, str | None] = {
    ...
    "ai_semiconductors_memory": "ai_infrastructure",
...
SECTOR_THEME_CODES: dict[str, list[str]] = {
    ...
    "AI Semiconductors and Memory": ["ai_semiconductors_memory"],
...
COMPANY_METADATA = {
    ...
    "AVGO": {"exchange": "NASDAQ", "country": "US", "industry": "Semiconductors"},
    "MRVL": {"exchange": "NASDAQ", "country": "US", "industry": "Semiconductors"},
    "MU": {"exchange": "NASDAQ", "country": "US", "industry": "Memory Semiconductors"},
    "MCHP": {"exchange": "NASDAQ", "country": "US", "industry": "Semiconductors"},
